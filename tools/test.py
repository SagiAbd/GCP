...
"""
python tools/test.py configs/gcp/gcp_r50_kazgisa-kostanai.py work_dirs/gcp_r50_query-300_12e_whu-mix-vector/epoch_12.pth  --show-dir results
"""
import argparse
import os
...
def main():
    ...
    # Compute run_dir and wandb_dir if wandb args are provided
    run_dir = None
    wandb_dir = None
    if args.wandb_name and args.wandb_group:
    ...
    # Inject wandb visualizer if wandb args are provided
