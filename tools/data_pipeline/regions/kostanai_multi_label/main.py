...
PIPELINE_CONFIGS = {
    'merge_kostanai_buildings': {
        ...
        'output_dir': r"./data/raw/labels/kostanai/multi-label/buildings_kostanai_tiles_merged/",
    ...
    'process_kostanai_buildings': {
        ...
        'output_dir': r"./data/raw/labels/kostanai/multi-label/buildings_kostanai_processed/"
    },
    'data_split': {
