...
class ProcessKostanaiBuildings:
    ...
    def create_multipolygons_from_groups(self, gdf, groups):
        ...
        for group in groups:
            ...
            # Determine building_type for the group
            if (group_df['building_type'] == 'residential').any():
                group_building_type = 'residential'
            else:
                group_building_type = 'non-residential'
            ...
            multipolygon_row['building_type'] = group_building_type
