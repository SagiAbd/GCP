                        ...
                        if intersection.geom_type == 'GeometryCollection':
                            for geom in intersection.geoms:
                                if geom.geom_type == 'Polygon':
                                    self._process_single_polygon_optimized(geom, tiff_path, chunk_info, annotations)
                        elif intersection.geom_type == 'Polygon':
                            self._process_single_polygon_optimized(intersection, tiff_path, chunk_info, annotations)
                        elif intersection.geom_type == 'MultiPolygon':
                            for polygon in intersection.geoms:
                                self._process_single_polygon_optimized(polygon, tiff_path, chunk_info, annotations)
                    except Exception as e:
                        continue
            
            chunk_info['annotations'] = annotations
    
    def _process_single_polygon_optimized(self, polygon, tiff_path, chunk_info, annotations):
