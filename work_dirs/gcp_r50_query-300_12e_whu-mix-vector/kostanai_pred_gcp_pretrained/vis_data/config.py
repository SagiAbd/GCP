...
data_root = 'D:\\Sagi\\GCP\\GCP\\data\\kazgisa-kostanai-test'
...
img_norm_cfg = dict(
    ...
    to_rgb=True)
launcher = 'none'
load_from = 'work_dirs/gcp_r50_query-300_12e_whu-mix-vector/epoch_12.pth'
log_level = 'INFO'
...
test_evaluator = [
    dict(
        ann_file='D:\\Sagi\\GCP\\GCP\\data\\kazgisa-kostanai-test\\test.json',
        backend_args=None,
...
work_dir = './work_dirs\\gcp_r50_query-300_12e_whu-mix-vector'
