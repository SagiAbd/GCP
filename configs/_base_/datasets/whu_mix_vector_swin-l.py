...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='whu-mix-vector-val/val.json',
        data_prefix=dict(img='whu-mix-vector-val/image'),
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='whu-mix-vector-test1/image'),
        # ann_file='test1/test-small.json',
        ann_file='whu-mix-vector-test1/test.json',
