...
log_config = dict(hooks=[
    ...
    dict(
        init_kwargs=dict(
            ...
            name='mask2former_on-gcp_e20_kostanai_afs',
...
vis_backends = [
    dict(
        init_kwargs=dict(
            ...
            resume='never'),
        save_dir=
        'work_dir\\mask2former_training\\mask2former_on-gcp_e20_kostanai_afs\\wandb',
...
work_dir = 'work_dir\\mask2former_training\\mask2former_on-gcp_e20_kostanai_afs'
