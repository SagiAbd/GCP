...
data_root = 'D:\\Sagi\\GCP\\GCP\\data\\processed\\whu-mix'
...
test_evaluator = [
    dict(
        ann_file='D:\\Sagi\\GCP\\GCP\\data\\processed\\whu-mix\\val\\val.json',
        backend_args=None,
...
vis_backends = [
    dict(
        init_kwargs=dict(
            ...
            group='gcp_training',
            name='gcp-training-on-whu-mix-val',
            project='building-segmentation-gcp',
            resume='never'),
        save_dir='work_dir\\gcp_training\\gcp-training-on-whu-mix-val\\wandb',
    ...
    vis_backends=[
        dict(
            init_kwargs=dict(
                ...
                resume='never'),
            save_dir=
            'work_dir\\gcp_training\\gcp-training-on-whu-mix-val\\wandb',
            type='WandbVisBackend'),
    ])
work_dir = 'work_dir\\gcp_training\\gcp-training-on-whu-mix-val'
