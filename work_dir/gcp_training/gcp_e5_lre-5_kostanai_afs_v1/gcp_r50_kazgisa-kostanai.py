...
vis_backends = [
    dict(
        init_kwargs=dict(
            ...
            group='gcp_training',
            name='gcp_e5_lre-5_kostanai_afs_v1',
            project='building-segmentation-gcp',
            resume='never'),
        save_dir='work_dir\\gcp_training\\gcp_e5_lre-5_kostanai_afs_v1\\wandb',
    ...
    vis_backends=[
        dict(
            init_kwargs=dict(
                ...
                resume='never'),
            save_dir=
            'work_dir\\gcp_training\\gcp_e5_lre-5_kostanai_afs_v1\\wandb',
            type='WandbVisBackend'),
    ])
work_dir = 'work_dir\\gcp_training\\gcp_e5_lre-5_kostanai_afs_v1'
