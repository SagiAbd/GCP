...
vis_backends = [
    dict(
        init_kwargs=dict(
            ...
            group='gcp_training',
            name='gcp-training-on-whu-mix-val-on-our-mask2former',
            project='building-segmentation-gcp',
            resume='never'),
        save_dir=
        'work_dir\\gcp_training\\gcp-training-on-whu-mix-val-on-our-mask2former\\wandb',
...
work_dir = 'work_dir\\gcp_training\\gcp-training-on-whu-mix-val-on-our-mask2former'
