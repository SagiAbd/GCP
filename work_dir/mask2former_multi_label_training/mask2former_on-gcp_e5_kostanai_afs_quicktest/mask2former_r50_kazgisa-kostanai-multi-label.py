...
data_root = 'data/processed/multi-label-kostanai'
...
log_config = dict(hooks=[
    ...
    dict(
        init_kwargs=dict(
            ...
            group='mask2former_multi_label_training',
            name='mask2former_on-gcp_e5_kostanai_afs_quicktest',
...
vis_backends = [
    dict(
        init_kwargs=dict(
            ...
            resume='never'),
        save_dir=
        'work_dir\\mask2former_multi_label_training\\mask2former_on-gcp_e5_kostanai_afs_quicktest\\wandb',
...
work_dir = 'work_dir\\mask2former_multi_label_training\\mask2former_on-gcp_e5_kostanai_afs_quicktest'
