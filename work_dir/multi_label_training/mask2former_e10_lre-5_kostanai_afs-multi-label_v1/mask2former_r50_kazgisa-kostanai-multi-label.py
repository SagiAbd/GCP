...
log_config = dict(hooks=[
    ...
    dict(
        init_kwargs=dict(
            ...
            group='multi_label_training',
            name='mask2former_e10_lre-5_kostanai_afs-multi-label_v1',
...
vis_backends = [
    dict(
        init_kwargs=dict(
            ...
            resume='never'),
        save_dir=
        'work_dir\\multi_label_training\\mask2former_e10_lre-5_kostanai_afs-multi-label_v1\\wandb',
...
work_dir = 'work_dir\\multi_label_training\\mask2former_e10_lre-5_kostanai_afs-multi-label_v1'
